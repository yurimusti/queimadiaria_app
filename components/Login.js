...
export default class componentName extends Component {
  ...
  login() {
    let link =
      "https://api.themoviedb.org/3/authentication/token/new?api_key=85822ce5637e2d31d260901abc746e87";
    ...
    fetch(link, {
      ...
      .then(response => {
        response.json().then(data => {
          //Session with login
          fetch(
            "https://api.themoviedb.org/3/authentication/token/validate_with_login?api_key=85822ce5637e2d31d260901abc746e87&username=yurimusti&password=marcella00&request_token=" +
              data.request_token,
            {
              method: "GET",
              headers: new Headers({
            ...
            .then(response => {
              //Session
              fetch(
                "https://api.themoviedb.org/3/authentication/session/new?api_key=85822ce5637e2d31d260901abc746e87&request_token=" +
                  data.request_token,
                {
                  method: "GET",
                  headers: new Headers({
